...
# included so PDF reports render here without a sandbox. No .env is copied; pass secrets as
# environment variables or a mounted file.
...
COPY skills ./skills
COPY docs/business-context ./docs/business-context
