...
5. Code renders metric strips, account comparison charts, tables, number formats, missing states,
   ...
   the `report-design` skill and do not replace the reconciled report.
