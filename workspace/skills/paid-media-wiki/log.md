...
## 2026-09-12 · Deployment customization

Setup exposes two deployment paths and optional MDA Slack branding, triggers, and report timing.
The CLI shares validation. Saving timing updates only MDA schedule cron/timezone literals; reporting
windows, authored prompts, deployment identity, and approval policy are preserved.
