...
- Deployment exposes MDA and self-hosting as two visible paths. MDA Slack branding, message
  triggers, and report timing are operator configuration. Scheduling changes preserve report
  prompts and analysis windows, and never bypass approval.
