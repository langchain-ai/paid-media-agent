...
| Implement the system | [SPEC.md](SPEC.md) and [IMPLEMENTATION_PROMPT.md](IMPLEMENTATION_PROMPT.md) |
| Understand runtime boundaries | [docs/architecture/README.md](docs/architecture/README.md) |
...
| Set up locally | `uv run paid-media-agent setup` (console) or the CLI groups in [README.md](README.md) |
